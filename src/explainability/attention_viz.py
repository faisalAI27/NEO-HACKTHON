...
class AttentionVisualizer:
    def __init__(self, checkpoint_path, fold=0, device=None, output_dir='results/attention'):
        ...
        # Storage
        self.patient_attention = {} # case_id -> {modality: attn, wsi_attn: ..., rna_attn: ...}
    ...
    def visualize_wsi_heatmap(self, case_id, top_k=5):
        ...
        try:
            with h5py.File(h5_path, 'r') as f:
                ...
                sc = plt.scatter(coords[:, 0], -coords[:, 1], c=attn, cmap='viridis', alpha=0.6, s=20)
                ...
                if 'imgs' in f:
                    ...
                    plt.tight_layout()
                    plt.savefig(os.path.join(self.output_dir, f'wsi_top_tiles_{case_id}.png'))
                    plt.close()
...
if __name__ == "__main__":
    ...
    viz = AttentionVisualizer(args.checkpoint, fold=args.fold, output_dir=args.output_dir)
